...
- Analyser si l'évolution de l'audience change dans un sens ou dans l'autre la part de femmes à l'antenne
- 

# Jeux de données
Nous avons à notre disposition trois tables que nous mettons en relation afin de répondre aux questions précédentes.
- sujet_tele: indique le temps en second et la thématique des sujets abordés aux JT du soir de différentes chaînes entre 
